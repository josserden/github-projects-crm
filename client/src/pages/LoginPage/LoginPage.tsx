...
import { LoginPayload, login } from "@/api/auth.ts";
...
export const LoginPage = () => {
  ...
  return (
    <AuthHero title="Welcome back!" description="Login to your account to access your projects.">
      <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          <AuthForm onSubmit={handleLogin} buttonText="Login" isLoading={isPending} />

          {error && <ErrorMessage>Invalid credentials. Please try again.</ErrorMessage>}

          <AuthLink to={Routes.REGISTER} label="Register here" title="Don't have an account?" />
        </div>
      </div>
    </AuthHero>
  );
